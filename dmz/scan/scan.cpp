...
#define EXTRA_TIME_FOR_EXPIRY_IN_MICROSECONDS 1000 // once the card number has been successfully identified, allow a bit more time to figure out the expiry //lgq 一旦卡号被成功识别，请多一点时间才能确定到期时间
